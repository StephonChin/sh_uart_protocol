...
### command information
```
 The protocol for show twinkle product controlled by voice sound
 Created by DeshengChin at 30 OCT 2018 
```
typedef enum TWINKLE_CMD_T{
    CMD_NONE                = 0x00, 
    CMD_SOCKET_ON           = 0x40, 
    CMD_SOCKET_OFF          = 0x41;
    
    CMD_THEME_SET           = 0x42,     // Change color or theme
                                        // len = 1  >>          Value from 0 to 0x1C
                                        //---------------------------------------------------
                                        //                      0x00 - Red
                                        //                      0x01 - Green
    ...
    CMD_TIMER_SET           = 0x45,     // Set timer
                                        // len = 1              Value from 0 to 12 (even number)
                                        //------------------------------------------------------
                                        //                      0 - timer off
                                        //                      n - set n hours


    CMD_MSC_EN              = 0x46,     // Music mode enable or disable
                                        // len = 1              Value from 0 to 1
                                        //------------------------------------------------------
                                        //                      0     - disable
                                        //                      other - enable
